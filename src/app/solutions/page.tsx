...
export const metadata: Metadata = {
  ...
  description:
    "Discover TRVERSE solutions: Automated Fare Collection, Intelligent Transport Systems, AI Scheduling, Control Room Management, and Micro-Mobility Integration.",
};
